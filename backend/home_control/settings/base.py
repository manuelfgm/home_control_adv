"""
Configuración base para Home Control Advanced
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-)1l!)we(fn4tq6whi)(fhlwdzk5c2d8fdy$sbb)37i28+!^y7e')
...
MQTT_CLIENT_ID = os.getenv('MQTT_CLIENT_ID', 'home_control_django')
